...
import com.dumptruckloads.truckcalc.databinding.ActivityHaulDifferenceBinding;
import com.dumptruckloads.truckcalc.model.HaulDifferenceViewModel;

public class HaulDifferenceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ActivityHaulDifferenceBinding binding = DataBindingUtil.setContentView(this, R.layout.activity_haul_difference);
        binding.setModel(new HaulDifferenceViewModel());
        ...
        screenName.setText(getResources().getString(R.string.label_info_hd));

        imageButton.setOnClickListener(arg0 -> {

            AlertDialog.Builder builder = new AlertDialog.Builder(HaulDifferenceActivity.this);
            LayoutInflater inflater = HaulDifferenceActivity.this.getLayoutInflater();
            ...
            tvTitle.setText(getResources().getString(R.string.label_info_hd));

            TextView tvText = dialogView.findViewById(R.id.information_dialog_information_text);
            tvText.setText(getResources().getString(R.string.text_info_hd));
