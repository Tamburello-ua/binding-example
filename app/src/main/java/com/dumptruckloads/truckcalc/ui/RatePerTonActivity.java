...
import com.dumptruckloads.truckcalc.databinding.ActivityRatePerTonBinding;
import com.dumptruckloads.truckcalc.model.RatePerTonViewModel;

public class RatePerTonActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ActivityRatePerTonBinding binding = DataBindingUtil.setContentView(this, R.layout.activity_rate_per_ton);
        binding.setModel(new RatePerTonViewModel());
        ...
        screenName.setText(getResources().getString(R.string.label_info_rpt));

        imageButton.setOnClickListener(arg0 -> {

            AlertDialog.Builder builder = new AlertDialog.Builder(RatePerTonActivity.this);
            LayoutInflater inflater = RatePerTonActivity.this.getLayoutInflater();
            ...
            tvTitle.setText(getResources().getString(R.string.label_info_rpt));

            TextView tvText = dialogView.findViewById(R.id.information_dialog_information_text);
            tvText.setText(getResources().getString(R.string.text_info_rpt));
